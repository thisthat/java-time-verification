...
Constants 
{
  ...
  public static final String AZUREUS_VERSION  = "5.7.2.1_B04";
  public static final String BUILD_VERSION  = "5721-04";   //Ant replace
  	...
  	String	version )
  {
	...
	{	
		try{
			version_1 = version_1.replaceAll( "_B04", "_B100" );
			version_2 = version_2.replaceAll( "_B04", "_B100" );
