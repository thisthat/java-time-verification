...
public class NVar {
    ...
    static String sqlInsert = "INSERT INTO public.\"NumberOfVarPerMethod\"" +
            "(\"fileID\", \"nVars\")" +
            " VALUES (?, ?);";
    ...
    public static void main(String[] args) throws Exception {
        ...
        new NVar().doWork(base_path, fileName, className, methodName, signature, id);
    }
    ...
    public void doWork(String base_path, String filename, String className, String methodName, String signature, String id) throws Exception {
        ...
        saveDB(
                id,
                CountVars.get(_method, _zlass)
        );
        //closeFiles();
    }

    private void saveDB(String id, long nVars) throws Exception {
